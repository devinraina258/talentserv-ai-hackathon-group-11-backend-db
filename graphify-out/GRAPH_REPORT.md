...
## Summary
- 249 nodes · 429 edges · 30 communities (23 shown, 7 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b32db4fd`
...
- `setup_office_leave()` --calls--> `install_office_leave()`  [INFERRED]
  scripts/bootstrap_mcp.py → scripts/mcp_install_lib.py
...
Cohesion: 0.13
Nodes (9): init_db(), Connection, Path, run_sql_file(), init_db(), main(), Create SQLite database from packaged schema.sql and seed.sql., run_sql_file() (+1 more)
...
Cohesion: 0.57
Nodes (7): _create_venv_python(), install_graphify(), install_office_leave(), main(), merge_mcp_json(), _venv_python(), write_launcher()
...
## Knowledge Gaps
- **51 isolated node(s):** `prepare`, `graphify:sync`, `graphify:sync:unix`, `husky`, `command` (+46 more)
...
- **Why does `connect()` connect `Community 0` to `Community 4`?**
